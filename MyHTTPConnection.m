...
- (NSObject<HTTPResponse> *)httpResponseForMethod:(NSString *)method URI:(NSString *)path
{
	...
	if ([method isEqualToString:@"POST"] && [path isEqualToString:@"/upload.html"])
	{
		...
		for( NSString* filePath in uploadedFiles ) {
			//generate links
			[filesStr appendFormat:@"<img src=\"%@\"/> %@ <br/>",filePath, [filePath lastPathComponent]];
            NSString *newfilepath=[NSString stringWithFormat:@"%@%@%@",NSTemporaryDirectory(),@"upload/",[filePath lastPathComponent]];
            NSLog(@"dayin filepath %@",newfilepath);
            UIImage *img=[UIImage imageWithContentsOfFile:newfilepath];
